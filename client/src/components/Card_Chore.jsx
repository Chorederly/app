...
// styled components - notice the ${props =>props.theme....}, that is a callback
// function inside a template litteral ands is how you access props you pass to
// the element through attributes in the JSX or through the theme context
const CardWrapper = styled.div `
    ...
    padding: 20px;
    margin: 10px;
    background-color: ${props => props.theme.light_25};
...
`
      ...
      const ChoreCard = props => {
        // access the methods and data passed through context - used to give
        // functionality to the buttons, checkmark, etc
        ...
        // When checkbox is checked, the chore is marked as completed in the database and
        // the current timestamp is added to its history and all chores are updated on
        // the client side, which triggers css to show the checkbox as checked and
        // adding a line-through to the text. Also reverses the process if unchecked
        // ***todo: add validation on the model to block multiple timestamps added oer
        // day***
